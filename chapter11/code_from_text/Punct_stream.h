...
class Punct_stream {
	//like an istream, but the user can
	//add to this stream the set of whitespace characters
public:
	...
	operator bool();
private:
	istream& source;//charactersource
	istringstream buffer;//we let buffer do our formatting
	string white;//characters concidered "whitespace"
