...
*/
	string genre_to_string(Genre g) {
		...
		if (g == Genre::nonfiction) { return "nonfiction"; }
		if (g == Genre::periodical) { return "periodical"; }
		if (g == Genre::biography) { return "biography"; }
		if (g == Genre::children) { return "children"; }
	}
