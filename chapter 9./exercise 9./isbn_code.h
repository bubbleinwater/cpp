...
namespace Book {
	...
	public:
		...
		bool IN_THE_LIBRARY()const { if (in_the_library)return true; else return false; }
	...
	public:
		...
		void checkout() { is_checkedout = true; }//to checkout 
		void checkin() { is_checkedout = false; }//to checkin
	...
	public:
		...
		void checkout_book(Book& b, Patron& p,vector<Book>& v_b);
		void checkin_book(Book& b, Patron& p, vector<Book>& v_b);
